...
<div class="container-fluid">
    ...
    <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 nopadding">
        ...
        <div class="wrap">
            <form action="/admin/post/manage/<?= $post->id ?>/update" method="post">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="titleLabel">Title</label>
                            <input type="text" name="post_title" class="form-control" id="titleLabel" placeholder="Title of my post" value="<?= $post->title ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="post_category" id="categoryLabel">
                                ...
                                <option value="<?= $category->id ?>" <?= $category->id == $post->id_category ? 'selected' : '' ?>><?= $category->category_name ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <textarea class="form-control" name="post_content" id="editor"><?= $post->content ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="post_path" class="form-control" id="pathLabel" placeholder="/news/my-post" value="<?= $post->path ?>" required>
                        </div>
                    </div>
                </div>
                <div class="row">
